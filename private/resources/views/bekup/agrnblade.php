					...
					<div class="row">
									...
									<?php endforeach; ?>
									 {!! Form::open(array('route' => 'agen.store','method'=>'POST', 'enctype' => 'multipart/form-data' )) !!}
										<div class="form-group">
											...
											{!! Form::text('idAgen', '', ['class' => 'form-control form-control-sm' . ( $errors->has('idAgen') ? ' is-invalid' : '' ),'placeholder' => 'Masukan ID Agen', old('idAgen'), 'autofocus', 'required']) !!}
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											{!! Form::text('username', '', ['class' => 'form-control form-control-sm' . ( $errors->has('username') ? ' is-invalid' : '' ),'placeholder' => 'Masukan Username', old('username'), 'autofocus', 'required']) !!}
										</div>
										<div class="form-group">
											{!! Form::label('Password', 'Password', ['class' => 'control-label']) !!}
											{!! Form::password('password', ['class' => 'form-control form-control-sm' . ( $errors->has('password') ? ' is-invalid' : '' ), 'placeholder' => 'Masukan Password', 'required']) !!}
										</div>
						...
						<div class="col-sm-8">
							<div class="card">
								...
								<div class="card-body">	
									<div id="mapid" style="height:532px"></div>								
								</div>
							</div>
						</div>
					</div>
