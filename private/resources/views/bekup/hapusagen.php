				...
				<div class="col-sm-10">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-current="page">Deaktivasi Agen</li>
						</ol>
					</nav>
					@if(session('sukses'))
					...
					<div class="card">
						...
						<div class="card-body text-center">
							<h5>Apakah Akan Deaktivasi</h5>
							 {!! Form::open(array('route' => ['pages.deaktivasi',$agen],'method'=>'POST', 'enctype' => 'multipart/form-data' )) !!}
