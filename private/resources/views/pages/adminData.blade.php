			...
			<div class="row">
				<div class="col-sm-2">
					<ul class="list-group">
						...
						<a href="{{url('dataDistribusi')}}" class="list-group-item list-group-item-action">
					...
					<div class="text-center row">
						<div class="col-sm-4">
							<div class="card mb-3">
								...
								<div class="card-header text-right">
									<a href="{{url('dataAgen')}}" class="list-group-item list-group-item-action text-white bg-dark">
										Lihat Detail
						...
						<div class="col-sm-4">
							<div class="card mb-3">
								...
								<div class="card-header text-right">
									<a href="{{url('dataPenyalur')}}" class="list-group-item list-group-item-action text-white bg-dark">
										Lihat Detail
										<i class='fas fa-angle-double-right'></i>
									</a>
								</div>
						...
						<div class="col-sm-4">
							<div class="card mb-3">
								...
								<div class="card-header text-right">
									<a href="{{url('dataDistribusi')}}" class="list-group-item list-group-item-action text-white bg-dark">
										Lihat Detail
										<i class='fas fa-angle-double-right'></i>
									</a>
								</div>
